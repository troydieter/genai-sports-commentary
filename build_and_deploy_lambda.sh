...
aws lambda create-function --function-name bedrock-play-by-play-commentary-processor --role "arn:aws:iam::550767824695:role/GenAILambdaExecutionRole" --runtime "python3.9" --handler "lambda_function" --zip-file fileb://kinesis-stream-processor.zip
